...
The release workflow builds candidates without publishing them. Publication
requires a manual dispatch on an annotated tag by `JalenBuildsHub`, all CI and
CodeQL gates, provenance attestation, and the protected `pypi` environment.
